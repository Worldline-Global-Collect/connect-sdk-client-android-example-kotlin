...
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields.PreferredInputType.DATE_PICKER
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields.PreferredInputType.EMAIL_ADDRESS_KEYBOARD
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields.PreferredInputType.INTEGER_KEYBOARD
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields.PreferredInputType.PHONE_NUMBER_KEYBOARD
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields.PreferredInputType.STRING_KEYBOARD
...
class PaymentCardField(context: Context, attributeSet: AttributeSet) : ConstraintLayout(context, attributeSet) {
    ...
    fun setPaymentProductField(
        ...
        this.paymentProductField.displayHints?.let { displayHints ->
            cardFieldTextInputEditText.hint = displayHints.placeholderLabel
            setEditTextInputType(displayHints.preferredInputType)
        }
    ...
    private fun addTooltipWhenAvailable() {
        paymentProductField.displayHints?.tooltip?.let {
    ...
    private fun addMaskTextWatcherWhenAvailable() {
        ...
        paymentProductField.displayHints?.mask?.let {
